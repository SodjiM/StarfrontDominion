...
const Abilities = {
  ...
  microthruster_shift: {
    ...
    description: '+3 tiles movement for this turn (self).',
    shortDescription: '+3 tiles this turn.',
    longDescription: 'Overcharge lateral microthrusters to gain +3 movement for the current turn. Does not require targeting.',
    type: 'active',
    target: 'self',
    cooldown: 5,
    energyCost: 1
  ...
  emergency_discharge_vent: {
    ...
    description: 'Jettisons all cargo into a public can (10 HP, 25 capacity). Also +3 movement and +50% evasion for 1 turn.',
    shortDescription: 'Dump cargo → public can; +3 move, +50% evasion (1T).',
    longDescription: 'Immediately jettisons all carried minerals into a deployable public cargo can (10 HP, 25 capacity) that any player adjacent may transfer to/from. Can despawns 10 turns after becoming empty. Grants +3 movement and +50% evasion for 1 turn.',
    type: 'active',
    target: 'self',
    cooldown: 10,
    energyCost: 2,
